...
class ImageNetLTDataLoader(DataLoader):
    ...
    classnames_txt = "./data_txt/ImageNet_LT/classnames.txt"

    def __init__(self, data_dir, batch_size, val_batch_size=None, shuffle=True, num_workers=1, training=True, balanced=False, retain_epoch_size=True, resolution=224,
        ...
        super().__init__(dataset=self.dataset, **self.init_kwargs, sampler=sampler, drop_last=drop_last) # Note that sampler does not apply to validation set
    ...
    def split_validation(self):
        ...
        return DataLoader(dataset=self.val_dataset, **self.val_init_kwargs, drop_last=self.drop_last)
